...
<div class="card card-primary">
    <div class="card-header"><h3 class="card-title"><i class="fas fa-filter"></i> শ্রেণি ও তারিখ নির্বাচন</h3></div>
                            ...
                            <td>
                                @foreach(['present'=>'উপস্থিত','absent'=>'অনুপস্থিত','late'=>'বিলম্ব','leave'=>'ছুটি','holiday'=>'বন্ধ'] as $key=>$label)
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label class="custom-control-label" for="st_{{ $student->id }}_{{ $key }}">{{ $label }}</label>
                                    </div>
                                @endforeach
                            </td>
                            <td>
